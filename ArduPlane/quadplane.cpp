...
bool QuadPlane::setup(void)
{
    ...
    if (tilt.tilt_mask != 0) {
        ...
        if (tilt.tilt_type == TILT_TYPE_VECTORED_YAW) {
            ...
            SRV_Channels::set_range(SRV_Channel::k_tiltMotorFrontLeft, 1000);    ///< AerTilt
            SRV_Channels::set_range(SRV_Channel::k_tiltMotorFrontRight, 1000);   ///< AerTilt
            SRV_Channels::set_range(SRV_Channel::k_tiltMotorBackLeft, 1000);     ///< AerTilt
            SRV_Channels::set_range(SRV_Channel::k_tiltMotorBackRight, 1000);    ///< AerTilt
