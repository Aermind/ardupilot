...
void ModeQStabilize::update()
{
    ...
    float aertilt_lean = SRV_Channels::get_output_norm(SRV_Channel::k_rcin8); ///< For AerTilt
    float pitch_input = -aertilt_lean * 90.0f; // plane.channel_pitch->norm_input(); ///< For AerTilt
